...
class PolicyPage extends StatefulWidget {
  ...
  const PolicyPage({Key? key, this.showAgreeButton = true}) : super(key: key);
      ...
      body: SafeArea(
        child: Column(
          children: [
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // مربع الموافقة - إظهاره فقط إذا showAgreeButton = true
                    if (widget.showAgreeButton) _buildAgreementBox(),
            ...
            // أزرار التصرف - إظهارها فقط إذا showAgreeButton = true
            if (widget.showAgreeButton) _buildActionButtons(),
          ],
        ),
      ),
    );
